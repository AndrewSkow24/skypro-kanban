          ...
          <div className="pop-exit" id="popExit">
            <div className="pop-exit__container">
              <div className="pop-exit__block">
                ...
                <form action="#" className="pop-exit__form" id="formExit">
            ...
            <div className="pop-new-card__container">
              <div className="pop-new-card__block">
                <div className="pop-new-card__content">
                  ...
                  <a className="pop-new-card__close" href="#">
                    ✖
                  </a>
                  <div className="pop-new-card__wrap">
                    ...
                    >
                      <div className="form-new__block">
                        <label className="subttl" htmlFor="formTitle">
                          Название задачи
                        </label>
                        <input
                          autoFocus
                      ...
                      <div className="form-new__block">
                        <label className="subttl" htmlFor="textArea">
                          Описание задачи
                        </label>
                        <textarea
                  ...
                  <div className="pop-browse__wrap">
                    ...
                    >
                      <div className="form-browse__block">
                        <label className="subttl" htmlFor="textArea01">
                          Описание задачи
                        </label>
                        <textarea
